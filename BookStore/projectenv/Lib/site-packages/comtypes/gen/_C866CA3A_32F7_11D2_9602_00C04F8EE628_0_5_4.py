...
__all__ = [
    'SPPS_RESERVED1', 'eLEXTYPE_PRIVATE2', 'DISPID_SpeechAudio',
    'SpShortcut', 'DISPID_SPRDisplayAttributes', 'SAFT24kHz8BitMono',
    'SPEI_ADAPTATION', 'SVSFIsFilename', 'SPWORD', 'DISPID_SAVolume',
    'DISPID_SpeechCustomStream', 'ISpeechRecoResultDispatch',
    'DISPID_SASNonBlockingIO', 'DISPID_SLAddPronunciationByPhoneIds',
    'SVSFNLPMask', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SRAImport',
    'DISPID_SRRAudio', 'SAFTADPCM_22kHzMono', 'SPSERIALIZEDPHRASE',
    'SpeechCategoryRecognizers', 'DISPID_SRGSetTextSelection',
    'SPXRO_Alternates_SML', 'SRADefaultToActive',
    'ISpeechGrammarRuleStateTransitions', 'SPINTERFERENCE',
    'SpeechGrammarTagDictation', 'SGLexicalNoSpecialChars', 'IStream',
    'SAFTADPCM_44kHzMono', 'SPEI_TTS_PRIVATE',
    'ISpPhoneticAlphabetSelection', 'DISPID_SpeechLexiconWords',
    'DISPID_SRGCmdSetRuleState', 'eLEXTYPE_PRIVATE13', 'ISpLexicon',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVSpeakCompleteEvent',
    'SAFTCCITT_uLaw_11kHzStereo', 'SBONone', 'eLEXTYPE_MORPHOLOGY',
    'eWORDTYPE_DELETED', 'DISPID_SpeechLexiconWord',
    'DISPID_SRGState', 'eLEXTYPE_RESERVED9',
    'DISPID_SOTIsUISupported', 'eLEXTYPE_PRIVATE11', 'SFTInput',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SABufferInfo',
    'SP_VISEME_13', 'DISPID_SOTs_NewEnum', 'DISPID_SOTsCount',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SVEBookmark',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPPFirstElement',
    'DISPID_SPPChildren', 'DISPID_SPRNumberOfElements', 'SPLO_STATIC',
    'SpNullPhoneConverter', 'SpCompressedLexicon',
    'SAFT22kHz16BitMono', 'eLEXTYPE_PRIVATE18', 'SPAS_STOP',
    'SPAR_High', 'SSTTTextBuffer', 'SVP_0', 'SPWORDPRONUNCIATIONLIST',
    'SAFT8kHz8BitMono', 'SPAR_Unknown', 'SPPS_RESERVED4',
    'DISPID_SABufferNotifySize', 'SpeechRecoContextState',
    'SpeechPartOfSpeech', 'eLEXTYPE_RESERVED7', 'SGLexical',
    'DISPID_SRRSetTextFeedback', 'SPRS_INACTIVE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpUnCompressedLexicon', 'DISPID_SPACommit', 'SINoise',
    'SP_VISEME_3', 'SASPause', 'SAFTCCITT_uLaw_11kHzMono',
    'SAFT22kHz8BitStereo', 'DISPID_SOTGetStorageFileName',
    'SGSExclusive', 'SPAO_RETAIN_AUDIO', 'DISPID_SDKCreateKey',
    '_RemotableHandle', 'DISPID_SOTGetAttribute', 'STSF_AppData',
    'SPPHRASERULE', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFTADPCM_44kHzStereo', 'SPVPRI_NORMAL', 'SLTUser',
    'SpeechGrammarState', 'DISPID_SRCRetainedAudioFormat',
    'SpeechVoiceSpeakFlags', 'ISpMMSysAudio', 'DISPID_SMSAMMHandle',
    'DISPID_SPIEnginePrivateData', 'ISpeechPhraseReplacements',
    'SpPhraseInfoBuilder', 'SECFDefault',
    'DISPID_SRGSetWordSequenceData', 'SAFT48kHz8BitMono',
    'ISpeechLexiconWords', 'SPCATEGORYTYPE', 'SVSFPersistXML',
    'SPEI_RESERVED6', 'SSFMCreateForWrite', 'DISPID_SRCVoice',
    'DISPID_SDKOpenKey', 'SVP_5', 'ISpPhoneConverter',
    'SPGS_DISABLED', 'SGPronounciation', 'DISPID_SAFGetWaveFormatEx',
    'SpeechCategoryAudioIn', 'DISPID_SpeechObjectTokenCategory',
    'SpeechDictationTopicSpelling', 'SWPUnknownWordUnpronounceable',
    'SpeechDataKeyLocation', 'DISPID_SpeechRecoContextEvents',
    'SP_VISEME_14', 'SPDKL_CurrentUser', 'DISPID_SRCERecognition',
    'DISPID_SRCERecognitionForOtherContext', 'SGDSActive',
    'ISpResourceManager', 'SAFTNonStandardFormat', 'ISpRecognizer3',
    'DISPID_SWFEExtraData', 'eLEXTYPE_PRIVATE10', 'SpeechDiscardType',
    'STCLocalServer', 'SPEI_PHONEME', 'SpeechAllElements',
    ...
    'SPVPRIORITY', 'DISPID_SRSetPropertyString', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVSpeakStream', 'SDTAll', 'SRARoot', 'SPDATAKEYLOCATION',
    'SP_VISEME_16', 'DISPID_SGRsCommitAndSave', 'ISpeechVoiceStatus',
    'SAFT48kHz16BitMono', 'SpSharedRecoContext',
    'DISPID_SPPEngineConfidence', 'SAFTCCITT_ALaw_44kHzMono',
    'SVF_None', 'SPEVENTSOURCEINFO', 'DISPID_SRSAudioStatus',
    'ISpeechAudioFormat', 'ISpRecognizer2',
    'DISPID_SVSLastBookmarkId', 'DISPID_SADefaultFormat',
    'ISpStreamFormatConverter', 'SAFTGSM610_22kHzMono',
    'DISPID_SRGRules', 'DISPID_SpeechDataKey', 'ISpObjectWithToken',
    'DISPID_SGRSTPropertyValue', 'SPSHT_NotOverriden',
    'DISPID_SVEViseme', 'SAFT16kHz8BitStereo',
    'SpeechRetainedAudioOptions',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRSClsidEngine',
    'ISpAudio', '_ISpeechVoiceEvents', 'SAFT44kHz16BitStereo',
    'SRAORetainAudio', 'DISPID_SAFType', 'ISpeechRecognizerStatus',
    'SPPHRASEPROPERTY', 'DISPID_SLPPartOfSpeech',
    'DISPID_SpeechLexiconPronunciation',
    'SpPhoneticAlphabetConverter', 'DISPID_SPEAudioTimeOffset',
    'SINone', 'SpeechPropertyLowConfidenceThreshold',
    'ISpeechLexiconWord', 'SITooLoud',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'eLEXTYPE_PRIVATE5',
    'SAFT44kHz8BitMono', 'SPPS_RESERVED2', 'SpeechRunState',
    'DISPID_SGRsCommit', 'SREPhraseStart', 'DISPID_SVGetAudioOutputs',
    'DISPID_SVSInputSentencePosition', 'ISpeechRecoGrammar',
    'DISPID_SRRTTickCount', 'SGRSTTDictation', 'DISPID_SRCEBookmark',
    'DISPID_SRCEventInterests', 'DISPID_SPCPhoneToId',
    'SDTAlternates', 'DISPID_SPCLangId', 'SPPHRASE',
    'ISpeechRecoResult2', 'DISPID_SBSRead', 'DISPID_SRRSaveToMemory',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPIAudioSizeTime', 'SDTRule',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRRTStreamTime',
    'SREPropertyNumChange', 'SPWORDLIST',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPPId', 'SpPhoneConverter',
    'SAFTADPCM_11kHzMono', 'SpeechMicTraining',
    'SRSInactiveWithPurge', 'SPPS_Modifier', 'DISPID_SGRSTsItem',
    'SPRECORESULTTIMES', 'SLODynamic', 'DISPID_SPRsCount',
    'SECFEmulateResult', 'SVP_9', 'DISPID_SPIEngineId',
    'ISpeechPhoneConverter', 'SGRSTTEpsilon', 'eLEXTYPE_USER',
    'DISPID_SRGetRecognizers', 'DISPID_SRCCreateGrammar',
    'SGDSInactive', 'DISPID_SAFGuid', 'SpeechAudioState',
    'SPEI_END_INPUT_STREAM', 'SpWaveFormatEx', 'SGRSTTTextBuffer',
    'DISPID_SpeechObjectToken', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SpeechPhraseBuilder', 'SPEI_RESERVED5',
    'ISpXMLRecoResult', 'DISPID_SGRSTs_NewEnum', 'SP_VISEME_0',
    'SPEI_VOICE_CHANGE', 'DISPID_SRCEHypothesis', 'SPCT_COMMAND',
    'SDTPronunciation', 'SVEVoiceChange', 'SREPropertyStringChange',
    'DISPID_SVPause', 'ISpRecognizer', 'DISPID_SpeechRecoResult2',
    'SECFNoSpecialChars', 'DISPIDSPTSI_ActiveLength',
    'ISpObjectToken', 'DISPID_SPARecoResult', 'eLEXTYPE_PRIVATE20',
    'ISpRecoCategory', 'ISpPhoneticAlphabetConverter',
    'SPAUDIOBUFFERINFO', 'DISPID_SPPNumberOfElements',
    'SpeechBookmarkOptions', 'SPCONTEXTSTATE', 'SPEI_MAX_TTS',
    'SAFT24kHz16BitMono', 'ISpeechObjectTokenCategory',
    'DISPID_SPISaveToMemory', 'SPEI_MIN_SR', 'SPEI_SR_PRIVATE',
    'DISPID_SWFESamplesPerSec', 'DISPID_SVSLastResult', 'SPVPRI_OVER',
    'DISPID_SLPType', 'Speech_StreamPos_RealTime', 'DISPID_SPPValue',
    'eLEXTYPE_PRIVATE17', 'SASRun', 'eLEXTYPE_RESERVED8',
    'SpeechDisplayAttributes', 'SPEI_START_INPUT_STREAM',
    'SRSEIsSpeaking', 'SPFM_OPEN_READWRITE', 'DISPID_SPRsItem',
    'SPSNoun', 'DISPID_SLGenerationId', 'DISPID_SREmulateRecognition',
    'SPEI_TTS_BOOKMARK', 'DISPID_SRIsUISupported',
    'SAFTADPCM_11kHzStereo', 'SpeechCategoryPhoneConverters',
    'SGRSTTRule', 'SAFT12kHz8BitStereo', 'tagSPTEXTSELECTIONINFO',
    'SpeechAudioProperties', 'SSFMOpenForRead', 'SPSSuppressWord',
    'DISPID_SRGDictationLoad', 'SPCS_DISABLED',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpEventSource',
    'SAFTText', 'SPAO_NONE', 'ISpRecoGrammar',
    'SGDSActiveWithAutoPause', 'eLEXTYPE_PRIVATE3', 'SVPNormal',
    'SpeechVisemeType', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPFM_CREATE_ALWAYS', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'STCRemoteServer', 'SVSFUnusedFlags', 'SPCT_SLEEP',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SPIRetainedSizeBytes',
    'SRERecognition', 'SPPS_LMA', 'DISPID_SBSSeek',
    'SPPS_SuppressWord', 'DISPID_SPPsCount',
    'DISPID_SpeechPhraseRule', 'eLEXTYPE_VENDORLEXICON',
    'SRTSMLTimeout', 'SpInprocRecognizer', 'eLEXTYPE_RESERVED10',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SpeechPhraseElements',
    'SAFT16kHz16BitStereo', 'DISPID_SOTCDefault',
    'DISPID_SWFEFormatTag', 'SpMemoryStream', 'SVP_3',
    'SAFT32kHz16BitMono', 'SREAllEvents', 'SVP_19',
    'SSSPTRelativeToCurrentPosition', 'SPFM_NUM_MODES',
    'DISPID_SOTCreateInstance', 'DISPID_SDKEnumValues',
    'DISPID_SpeechVoice', 'ISpShortcut', 'DISPID_SMSADeviceId',
    'ISpeechRecognizer', 'SP_VISEME_8', 'SVSFIsXML', 'SP_VISEME_12',
    'ISpeechMemoryStream', 'SpeechPropertyComplexResponseSpeed',
    'SAFTGSM610_44kHzMono', 'SVP_14', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SOTCategory', 'SP_VISEME_4', 'SpResourceManager',
    'SPAS_CLOSED', 'DISPID_SPRText', 'DISPID_SFSClose',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SVDisplayUI',
    'DISPID_SDKSetLongValue', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SLWType', 'ISpeechGrammarRuleStateTransition',
    'ISpStream', 'SPSUnknown', 'DISPID_SDKGetStringValue',
    'SRCS_Enabled', 'SPWF_SRENGINE', 'SPXRO_SML',
    'STSF_CommonAppData', 'SVEAudioLevel', 'DISPID_SPELexicalForm',
    'DISPID_SPAPhraseInfo', 'SpeechStreamSeekPositionType',
    'Speech_Default_Weight', 'DISPID_SpeechPhraseAlternate',
    'eLEXTYPE_PRIVATE8', 'SLTApp', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRGId', 'SVEPhoneme', 'DISPID_SRRAudioFormat',
    'SPWORDPRONOUNCEABLE', 'SVP_15', 'SGSEnabled', 'SSFMCreate',
    'SAFT8kHz16BitStereo', 'DISPID_SRGRecoContext',
    'DISPID_SDKGetBinaryValue', 'SPRECOCONTEXTSTATUS', 'SDTAudio',
    'Speech_Max_Word_Length', 'DISPID_SpeechVoiceStatus', 'SITooFast',
    ...
    'SREStateChange', 'SAFTCCITT_ALaw_22kHzStereo',
    ...
    'SpeechVoiceCategoryTTSRate', 'SRTExtendableParse', 'SPSHT_EMAIL',
    'SINoSignal', 'ISpStreamFormat', 'SP_VISEME_7',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPSVerb',
    'SPEI_HYPOTHESIS', 'SPWAVEFORMATTYPE', 'SVEAllEvents',
    ...
    'SWPUnknownWordPronounceable', 'DISPID_SGRSAddSpecialTransition',
    'SAFT11kHz16BitMono', 'SPEI_MIN_TTS', 'SSFMOpenReadWrite',
    'SpNotifyTranslator', 'SpeechRuleState', 'SRCS_Disabled',
    'SASClosed', 'DISPID_SVGetAudioInputs', 'DISPID_SRCEStartStream',
    'SAFT22kHz16BitStereo', 'DISPID_SMSALineId', 'DISPID_SGRsDynamic',
    'DISPID_SGRSTWeight', 'SREStreamEnd', 'SRAInterpreter',
    'ISpNotifySource', 'DISPID_SPEActualConfidence',
    'SECFIgnoreKanaType', 'LONG_PTR', 'SpAudioFormat', 'SPVISEMES',
    'SpeechAudioVolume', 'SpeechAudioFormatGUIDWave',
    'DISPID_SLWsCount', 'SPGS_EXCLUSIVE', 'SITooSlow',
    'DISPID_SMSGetData', 'eLEXTYPE_PRIVATE9', 'SPFILEMODE',
    'SRAExport', 'DISPID_SpeechRecognizerStatus', 'ISpeechBaseStream',
    'SVSFNLPSpeakPunc', 'SPGRAMMARWORDTYPE', 'SPPS_Interjection',
    'SPPROPERTYINFO', 'DISPID_SPRuleConfidence', 'SVEBookmark',
    'SREFalseRecognition', 'DISPID_SGRSAddWordTransition',
    'DISPID_SFSOpen', 'SDKLDefaultLocation',
    'DISPID_SPERetainedStreamOffset', 'SVEStartInputStream',
    'SVSFParseMask', 'SPRST_INACTIVE_WITH_PURGE', 'SPFM_CREATE',
    'DISPID_SLWsItem', 'ISpGrammarBuilder', 'SpeechWordType',
    'eLEXTYPE_PRIVATE1', 'DISPID_SVSPhonemeId',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SECFIgnoreWidth',
    'DISPID_SPAStartElementInResult', 'DISPID_SPEDisplayAttributes',
    'ISpEventSink', 'SAFTNoAssignedFormat', 'DISPID_SPEAudioSizeTime',
    'SPFM_OPEN_READONLY', 'DISPID_SPRulesCount',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechPhraseRules',
    'DISPID_SCSBaseStream', 'SPEI_START_SR_STREAM', 'ISpNotifySink',
    ...
    'SWPKnownWordPronounceable', 'SPRST_INACTIVE',
    'SVSFPurgeBeforeSpeak', 'SPEI_RECOGNITION',
    'SPINTERFERENCE_NOSIGNAL', 'SVSFlagsAsync', 'SVF_Stressed',
    'DISPID_SPIGetText', 'SPSERIALIZEDRESULT', 'SPSModifier',
    'DISPID_SRCRequestedUIType', 'DISPID_SLPsItem',
    'SpeechGrammarTagUnlimitedDictation', 'DISPIDSPTSI_ActiveOffset',
    'SP_VISEME_9', 'SITooQuiet', 'SRAONone', 'ISpPhrase',
    'SpeechRecognitionType', 'ISpeechLexicon',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPIGrammarId',
    'SVSFVoiceMask', 'DISPID_SpeechPhraseInfo', 'SpStream',
    'ISpDataKey', 'DISPID_SABIEventBias', 'SpeechWordPronounceable',
    ...
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SGRsCount', 'ISpProperties',
    'DISPID_SRRTimes', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SVEStreamEnd', 'DISPID_SPRuleName', 'SREAudioLevel',
    'DISPID_SVEPhoneme', 'SAFT11kHz8BitStereo', 'eLEXTYPE_APP',
    'SPEI_END_SR_STREAM', 'DISPID_SRCRecognizer',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SVEVoiceChange',
    'ISpeechPhraseElement', 'SPEI_PHRASE_START',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpeechGrammarRules',
    'DISPID_SBSFormat', 'SECHighConfidence', 'SAFT48kHz8BitStereo',
    'DISPID_SPPConfidence', 'SREStreamStart', 'DISPID_SLWWord',
    'SpeechStreamFileMode', 'DISPID_SVSpeak', 'SECFIgnoreCase',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechLexiconProns',
    'DISPID_SVEWord', 'SPAS_PAUSE', 'DISPID_SRCRetainedAudio',
    'DISPID_SRRRecoContext', 'SPSMF_UPS', 'DISPIDSPRG', 'SVP_4',
    'DISPID_SVSInputWordPosition', 'DISPID_SRProfile',
    'SPINTERFERENCE_NONE', 'eLEXTYPE_RESERVED4',
    'DISPID_SRCEPhraseStart', 'ISpeechGrammarRule', 'ISpVoice',
    'SpeechRecoProfileProperties', 'SpTextSelectionInformation',
    'DISPID_SRState', 'SPEI_VISEME', 'SPSHT_OTHER',
    'SpeechPropertyAdaptationOn', 'SDKLCurrentConfig',
    'DISPID_SRRTLength', 'DISPID_SVRate', 'DISPID_SPRs_NewEnum',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPRuleParent',
    'SPXMLRESULTOPTIONS', 'DISPID_SPEEngineConfidence',
    'DISPID_SGRSAddRuleTransition', 'SP_VISEME_17', 'SREPrivate',
    'DISPID_SASState', 'DISPID_SVEventInterests', 'ISequentialStream',
    'SPEI_SOUND_START', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SVSFParseAutodetect', 'SGDSActiveUserDelimited',
    'SPEI_FALSE_RECOGNITION', 'SPSMF_SAPI_PROPERTIES',
    'ISpeechPhraseProperties', 'SRERecoOtherContext',
    'DISPID_SLWPronunciations', 'DISPID_SRCEInterference',
    'DISPID_SVEAudioLevel', 'SAFTExtendedAudioFormat', 'ISpPhraseAlt',
    'eLEXTYPE_RESERVED6', 'SPWT_PRONUNCIATION', 'DISPID_SLPPhoneIds',
    'eLEXTYPE_PRIVATE12', 'SPRECOGNIZERSTATUS', 'DISPID_SRCState',
    'SPAR_Low', 'SPRECOSTATE', 'tagSPPROPERTYINFO', 'eWORDTYPE_ADDED',
    'SPINTERFERENCE_TOOFAST', 'SRTStandard',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRRSpeakAudio', 'SPEVENT',
    'SSSPTRelativeToEnd', 'DISPID_SVResume',
    'DISPID_SpeechVoiceEvent', 'SAFTCCITT_uLaw_22kHzMono',
    'SVSFIsNotXML', 'SpVoice', 'SPAS_RUN',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpeechTokenShellFolder',
    'SpeechLoadOption', 'SFTSREngine', 'SSTTWildcard', 'SWTAdded',
    'STCInprocHandler', 'DISPID_SRStatus',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRCEEnginePrivate',
    'DISPID_SGRSRule', 'DISPIDSPTSI', 'ISpRecoGrammar2',
    'ISpeechWaveFormatEx', 'IInternetSecurityMgrSite',
    'SPPARTOFSPEECH', 'DISPID_SRGReset', 'DISPID_SPPsItem',
    'SPBO_PAUSE', 'SVSFParseSapi', 'SREAdaptation', 'SVSFDefault',
    'SpeechTokenContext', 'DISPID_SRCSetAdaptationData', 'SVP_12',
    ...
    'DISPID_SRGIsPronounceable', 'SRSInactive',
    'SAFTADPCM_22kHzStereo', 'DISPID_SMSSetData',
    'ISpeechRecoContext', 'DISPID_SOTDisplayUI',
    'SECNormalConfidence', 'DISPID_SLWLangId', 'DISPID_SRCBookmark',
    'DISPID_SRSNumberOfActiveRules',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPWF_INPUT',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPDKL_LocalMachine', 'SPEI_TTS_AUDIO_LEVEL', 'SP_VISEME_15',
    'SAFT12kHz16BitMono', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SPAsCount', 'DISPID_SVGetVoices', 'DISPID_SRRAlternates',
    'DISPID_SRIsShared', 'DISPID_SPRuleId', 'SSTTDictation',
    'DISPID_SDKDeleteKey', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPEI_INTERFERENCE', 'DISPID_SOTGetDescription',
    'SPPHRASEREPLACEMENT', 'SAFTCCITT_ALaw_22kHzMono', 'SP_VISEME_11',
    'DISPID_SPIRule', 'SLOStatic', 'SP_VISEME_18',
    'DISPID_SVSyncronousSpeakTimeout', 'SDA_Consume_Leading_Spaces',
    'DISPID_SOTsItem', 'DISPID_SRCResume', 'SRATopLevel',
    'DISPID_SGRAddState', 'DISPID_SpeechAudioFormat',
    'SPINTERFERENCE_TOOQUIET', 'ISpeechPhraseProperty',
    'ISpRecoContext', 'SVP_2', 'ISpeechObjectTokens',
    'DISPID_SAStatus', 'DISPID_SGRId', 'DISPID_SPEsItem',
    'DISPID_SVSVisemeId', 'SRSActive', 'DISPID_SPIStartTime',
    'tagSTATSTG', 'DISPID_SGRSTPropertyId', 'eLEXTYPE_PRIVATE4',
    'SpeechPropertyResponseSpeed', 'DISPID_SWFEChannels',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRCESoundEnd',
    'SpFileStream', 'SGRSTTWildcard', 'DISPID_SRAudioInputStream',
    'STSF_LocalAppData', 'SPRST_ACTIVE', 'SpeechGrammarTagWildcard',
    'ISpeechXMLRecoResult', 'IInternetSecurityManager',
    'SPDKL_CurrentConfig', 'DISPID_SRSSupportedLanguages',
    'DISPID_SDKEnumKeys', 'SVESentenceBoundary',
    'DISPID_SGRsFindRule', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SpeechRecognizer', 'DISPID_SRGCommit',
    'DISPID_SpeechPhraseReplacements', 'SGSDisabled',
    'STSF_FlagCreate', 'SVP_6', 'DISPID_SPEPronunciation',
    'DISPID_SGRSTNextState', 'SpeechLexiconType',
    'ISpeechTextSelectionInformation', 'ISpeechPhraseAlternate',
    'SpInProcRecoContext', 'SPEI_RESERVED3', 'DISPID_SPIProperties',
    'DISPID_SGRSTransitions', '__MIDL_IWinTypes_0009', 'SP_VISEME_21',
    'SPSFunction', 'SPPS_RESERVED3', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPERequiredConfidence', 'SECLowConfidence',
    'SVEWordBoundary', 'SP_VISEME_6', 'DISPID_SPILanguageId',
    'SDTProperty', 'SpeechEmulationCompareFlags',
    'DISPID_SRCCreateResultFromMemory', 'SVPOver', 'SPLO_DYNAMIC',
    'ISpeechRecoResult', 'SpeechFormatType', 'SpLexicon',
    'SPAUDIOSTATUS', 'SAFT11kHz16BitStereo', 'SPEI_WORD_BOUNDARY',
    'SpeechGrammarWordType', 'SPSTREAMFORMATTYPE', 'SpMMAudioIn',
    'DISPID_SRGDictationUnload', 'SpeechAudioFormatType',
    'DISPID_SRDisplayUI', 'SPTEXTSELECTIONINFO',
    'SAFT24kHz8BitStereo', 'SPGS_ENABLED',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SVGetProfiles',
    'SAFT48kHz16BitStereo', 'DISPID_SGRInitialState',
    'SPEI_RESERVED2', 'SPCS_ENABLED', 'SPPS_Verb',
    'SpeechVisemeFeature', 'SPPS_Noncontent', 'DISPID_SLWs_NewEnum',
    'SPEI_PROPERTY_NUM_CHANGE', 'STCAll', 'SPBO_AHEAD',
    'DISPID_SLPsCount', 'DISPID_SRGetFormat', 'SDA_No_Trailing_Space',
    'SPAR_Medium', 'DISPID_SPAs_NewEnum', 'DISPID_SVEStreamStart',
    'SPSHORTCUTPAIRLIST', 'DISPID_SpeechAudioStatus', 'SREHypothesis',
    'DISPID_SVVoice', 'DISPID_SPRFirstElement', 'SPSNotOverriden',
    'ISpeechObjectToken', 'ISpSerializeState',
    'Speech_Max_Pron_Length', 'DISPID_SGRClear', 'SRADynamic',
    'SpeechPropertyNormalConfidenceThreshold', 'SpeechVoicePriority',
    'SP_VISEME_5', 'SREBookmark', 'SP_VISEME_19', 'SREInterference',
    'DISPID_SRRDiscardResultInfo', 'SVP_16', 'UINT_PTR',
    'SPDKL_DefaultLocation', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRAudioInput', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SpCustomStream', 'SPVOICESTATUS', 'SpeechTokenKeyUI',
    'SpeechPropertyHighConfidenceThreshold',
    'ISpeechPhraseAlternates', 'DISPID_SOTDataKey',
    'SpeechTokenValueCLSID', 'ISpNotifyTranslator',
    'DISPID_SRCEEndStream', 'ISpeechPhraseInfo', 'SPPS_Noun',
    'DISPID_SGRAttributes', 'DISPID_SVSCurrentStreamNumber',
    'IEnumSpObjectTokens', 'DISPID_SVAudioOutput',
    'DISPID_SAFSetWaveFormatEx', 'SPPS_NotOverriden',
    'SAFT12kHz16BitStereo', 'SPEI_RESERVED1', 'SpeechCategoryVoices',
    'SAFT16kHz16BitMono', 'SpeechCategoryRecoProfiles',
    'DISPID_SpeechMMSysAudio', 'SPGRAMMARSTATE',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SASetState',
    'SAFT32kHz16BitStereo', 'SAFT12kHz8BitMono', 'DISPID_SPRulesItem',
    'DISPID_SVESentenceBoundary', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SOTCSetId', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SPEAudioStreamOffset', 'SAFT24kHz16BitStereo',
    'SVSFParseSsml', 'SPBINARYGRAMMAR', 'DISPID_SpeechWaveFormatEx',
    'SpeechEngineProperties', 'SPLEXICONTYPE',
    'DISPID_SRCEFalseRecognition', 'SAFT16kHz8BitMono',
    'DISPID_SpeechPhoneConverter', 'SpObjectToken',
    'Speech_StreamPos_Asap', 'SPLOADOPTIONS', 'SPWT_DISPLAY',
    'SPRST_NUM_STATES', 'DISPID_SRGCmdSetRuleIdState',
    'ISpeechFileStream', 'DISPID_SOTCEnumerateTokens', 'SVEPrivate',
    'DISPID_SLGetPronunciations', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SAEventHandle', 'SPCT_SUB_COMMAND',
    'DISPID_SGRAddResource', 'DISPID_SRRGetXMLResult',
    'DISPID_SGRSTPropertyName', 'DISPID_SpeechPhraseProperties',
    'SVP_1', 'DISPID_SVSLastBookmark', 'SAFT22kHz8BitMono', 'SVP_17',
    'SRESoundEnd', 'SpeechPropertyResourceUsage',
    'SDA_One_Trailing_Space', 'ISpRecoResult', 'DISPID_SBSWrite',
    'SPAUDIOOPTIONS', 'DISPID_SpeechBaseStream', 'SpeechInterference',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SOTCGetDataKey',
    'SpeechAudioFormatGUIDText', 'SPSInterjection', 'DISPID_SOTSetId',
    'SVP_7', 'DISPID_SOTRemoveStorageFileName', 'SRTEmulated',
    'SDTReplacement', 'SpObjectTokenCategory', 'eLEXTYPE_PRIVATE19',
    'ISpeechLexiconPronunciation', 'ISpeechRecoResultTimes',
    'ISpeechPhraseInfoBuilder', 'DISPID_SRCEAdaptation',
    'ISpeechPhraseElements', 'DISPID_SLGetWords', 'SP_VISEME_20',
    'DISPID_SVSInputSentenceLength', 'SP_VISEME_1', 'SPEI_UNDEFINED',
    'DISPID_SRGCmdLoadFromFile', 'SPWORDTYPE', 'SRSEDone',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRGetPropertyNumber',
    'SpeechAddRemoveWord', 'SAFTDefault', 'eLEXTYPE_PRIVATE7',
    'DISPID_SWFEBlockAlign', 'SP_VISEME_10', 'SAFT32kHz8BitStereo',
    'IEnumString', 'DISPID_SDKSetStringValue', 'SAFTGSM610_8kHzMono',
    'SAFTGSM610_11kHzMono', 'eLEXTYPE_LETTERTOSOUND',
    'SpStreamFormatConverter', 'SPPS_Unknown',
    'DISPID_SDKGetlongValue', 'SPWT_LEXICAL', 'DISPID_SGRsItem',
    'SPSEMANTICFORMAT', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRSetPropertyNumber', 'SDKLLocalMachine',
    'SpeechVoiceEvents', 'DISPID_SABIMinNotification', 'SBOPause',
    'eLEXTYPE_PRIVATE6', 'SDTDisplayText', 'DISPID_SPIReplacements',
    'DISPID_SPEs_NewEnum', 'SPRULE', 'SVP_20', 'SpeechTokenKeyFiles',
    'DISPID_SpeechRecoContext', 'ISpeechGrammarRuleState',
    'SPEI_MAX_SR', '_SPAUDIOSTATE', 'DISPID_SOTMatchesAttributes',
    'eLEXTYPE_PRIVATE14', 'DISPID_SRRPhraseInfo', 'SPRULESTATE',
    'SPBO_NONE', 'SpMMAudioOut', 'SpMMAudioEnum', 'SVP_13',
    'SAFTCCITT_uLaw_22kHzStereo', '_ISpeechRecoContextEvents',
    'SPRS_ACTIVE', 'SVEEndInputStream', 'SPPS_Function',
    'SAFTCCITT_ALaw_11kHzMono', 'SPSLMA', 'SpeechRecoEvents',
    'SpeechRegistryUserRoot', 'SGDisplay', 'DISPID_SVEEnginePrivate',
    'ISpeechCustomStream', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRRecognizer', 'SPBO_TIME_UNITS', 'SPSHORTCUTPAIR',
    'DISPID_SLPLangId', 'SSSPTRelativeToStart',
    'SPINTERFERENCE_NOISE', 'DISPID_SASFreeBufferSpace',
    'SpeechCategoryAppLexicons', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechLexicon', 'WAVEFORMATEX', 'SPWORDPRONUNCIATION',
    'DISPID_SPIAudioSizeBytes', 'SRESoundStart', 'SVF_Emphasis',
    'SVP_8', 'SVP_18', 'SpSharedRecognizer', 'SVPAlert',
    'SAFT44kHz16BitMono', 'DISPID_SGRsAdd', 'DISPID_SVSkip',
    'DISPID_SRRGetXMLErrorInfo', 'SPVPRI_ALERT', 'SAFT32kHz8BitMono',
    'SRTReSent', 'DISPID_SGRs_NewEnum', 'SPPHRASEELEMENT',
    'STCInprocServer', 'DISPID_SGRName',
    'SpeechSpecialTransitionType', 'DISPID_SVStatus',
    'DISPID_SOTRemove', 'SPCT_DICTATION', 'SVP_10',
    'DISPID_SPIElements', 'SVP_11', 'ISpeechResourceLoader',
    'ISpeechVoice', 'DISPID_SRGetPropertyString',
    'SAFTCCITT_ALaw_8kHzStereo', 'SWTDeleted',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SGRSTType',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPRuleChildren',
    'SRSActiveAlways', 'SAFT8kHz8BitStereo', 'DISPID_SDKDeleteValue',
    'SDKLCurrentUser', 'DISPID_SRCreateRecoContext', 'SGRSTTWord',
    'SAFT11kHz8BitMono', 'SP_VISEME_2',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFT8kHz16BitMono',
    'SAFT44kHz8BitStereo', 'DISPID_SVIsUISupported',
    'ISpeechAudioStatus', 'DISPID_SVAlertBoundary',
    'DISPID_SGRSTsCount', 'SPSEMANTICERRORINFO', 'SVEViseme',
    'DISPID_SpeechObjectTokens', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SOTCId', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPSHT_Unknown', 'SPEVENTENUM', 'DISPID_SVWaitUntilDone',
    'DISPID_SVSRunningState', 'DISPID_SLPSymbolic',
    'ISpeechPhraseReplacement', 'DISPID_SRCPause',
    'DISPID_SpeechMemoryStream', 'SASStop', 'SpeechRecognizerState',
    'SRTAutopause', 'SPEI_SR_BOOKMARK', 'SVP_21',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SpeechFileStream',
    'DISPID_SLAddPronunciation', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SpeechRecoResult', 'SpeechRuleAttributes', 'ISpeechAudio',
    'SPCT_SUB_DICTATION', 'ISpeechPhraseRules', 'eLEXTYPE_PRIVATE16',
    'SpeechVoiceSkipTypeSentence', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SABIBufferSize', 'SpeechUserTraining',
    'SPSMF_SRGS_SAPIPROPERTIES', 'ISpRecoContext2', 'ISpeechDataKey',
    'DISPID_SRCEPropertyNumberChange', 'SPEI_SOUND_END',
    'SPAUDIOSTATE', 'DISPID_SGRSTText', 'SPSHORTCUTTYPE',
    'ISpeechMMSysAudio', 'DISPID_SASCurrentSeekPosition',
    'SAFTADPCM_8kHzMono', 'DISPID_SPRuleFirstElement',
    'SDTLexicalForm', 'DISPID_SPPs_NewEnum',
    'ISpeechLexiconPronunciations', 'SRERequestUI'
]
